...
function handle_errors(error)
{
    switch(error.code)
    {
        case error.PERMISSION_DENIED: bootbox.dialog("It seems you didn't share location data. Please share when prompted by your browser.", [{
                                "label" : "OK",
                                "class" : "btn-warning",
                            }]);
        break;

        case error.POSITION_UNAVAILABLE: bootbox.dialog("Unable to determine your location. Please try again.", [{
                                "label" : "OK",
                                "class" : "btn-warning",
                            }]);
        break;

        case error.TIMEOUT: bootbox.dialog("Unable to determine your location. Please try again.", [{
                                "label" : "OK",
                                "class" : "btn-warning",
                            }]);
        break;

        default: bootbox.dialog("Unable to determine your location. Please try again.", [{
                                "label" : "OK",
                                "class" : "btn-warning",
                            }]);
        break;
    ...
    geocoder.geocode({'latLng': latlng}, function(results, status) {
      ...
      setTimeout(function(){n.close(); }, 3000);
        ...
        $("input#locale").val(local);
          ...
          bootbox.dialog("Unable to determine your location. Please try again.", [{
                                "label" : "OK",
                                "class" : "btn-warning",
                            }]);
